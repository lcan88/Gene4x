net <- as.matrix(read.delim('./temp/net_mirna_unique_nodes.txt', header = FALSE, sep = "\t"))
#print(dim(net))
...
write.table(net,'./temp/net_mirna_unique_nodes_int.txt',sep='\t',row.names=FALSE,col.names=FALSE)
