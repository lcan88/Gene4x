 ...
 */
package org.geworkbench.bison.testing.collection;

import org.geworkbench.bison.testing.AbstractTestObject;
 ...
 * <p/>
 * If you're extending {@link org.geworkbench.bison.testing.list.AbstractTestList}, {@link AbstractTestSet},
...
public abstract class AbstractTestCollection extends AbstractTestObject {
    ...
    /**
     * Makes an object to test add() type functions, override for specific typed collections that required
     * for example a MapEntry.
     *
     * @return
     */
    public Object makeObjectToAdd() {
        return new Object();
    }
    ...
    public Object[] getFullNonNullElements() {
        return new Object[]{new String(""), new String("One"), new Integer(2), "Three", new Integer(4), "One", new Double(5), new Float(6), "Seven", "Eight", new String("Nine"), new Integer(10), new Short((short) 11), new Long(12), "Thirteen", "14", "15", new Byte((byte) 16)};
    }
    ...
    public Object[] getOtherNonNullElements() {
        return new Object[]{new Integer(0), new Float(0), new Double(0), "Zero", new Short((short) 0), new Byte((byte) 0), new Long(0), new Character('\u0000'), "0"};
    }
    ...
    public Object[] getOtherNonNullStringElements() {
        return new Object[]{"For", "then", "despite", /* of */"space", "I", "would", "be", "brought", "From", "limits", "far", "remote", "where", "thou", "dost", "stay"};
    }
    ...
    public void testUnsupportedAdd() {
        ...
        // GenericsNote: This is terrible, but I'm a little overwhelmed by the test classes at the moment and can't figure out how to do it correctly
