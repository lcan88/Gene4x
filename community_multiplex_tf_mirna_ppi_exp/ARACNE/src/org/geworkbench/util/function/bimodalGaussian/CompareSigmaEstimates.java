...
public class CompareSigmaEstimates {
    ...
    void compareEstimates(String[] args) {
        ...
        try {
            ...
            File dataFile = new File(readFileBase + "/SigmaResults/BimodalGaussianMiForSigmas.txt");
            ...
            Vector allFileData = FileUtil.readFile(dataFile, 1);
    ...
    void compareResults(int index1, int index2, String[] data1Line, String[] data2Line, FileWriter writer) {
        ...
        try {
            writer.write(index1 + "\t" + mi1 + "\t" + index2 + "\t" + mi2 + "\t" + expectedMiDiff + "\t" + expectedMiPctDiff);
