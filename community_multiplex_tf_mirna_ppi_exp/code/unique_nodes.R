ppi <- as.matrix(read.delim('./temp/net_ppi.txt', header = FALSE, sep = "\t"))
exp <- as.matrix(read.delim('./temp/exp_net.txt', header = FALSE, sep = "\t"))
mirna <- as.matrix(read.delim('./temp/net_mirna.txt', header = FALSE, sep = "\t"))
tf <- as.matrix(read.delim('./temp/net_tf.txt', header = FALSE, sep = "\t"))
