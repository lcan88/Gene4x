...
public abstract class AbstractTestList extends AbstractTestCollection {
    ...
    public void testListLastIndexOf() {
        ...
        Object[] other = getOtherElements();
        for (int i = 0; i < other.length; i++) {
            assertEquals("lastIndexOf should return -1 for nonexistent " + "element", list1.lastIndexOf(other[i]), -1);
            verify();
        }
    }
     ...
     * GenericsNote: This is not valid with the generics conversion, will reintroduce at a later date
     */
    /*
